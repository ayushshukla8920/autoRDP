...
which is what makes it useful as a GUI-automation exercise. To keep that
...
logger = logging.getLogger("rdpauto.codebase")
...
# typing demo, not a file transfer, so binaries and lock files add nothing.
CODE_SUFFIXES = {
